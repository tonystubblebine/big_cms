...
Gem::Specification.new do |s|
  ...
  s.test_files = [
    ...
    "test/rails_root/test/functional/big_site/sites_controller_test.rb",
    "test/rails_root/test/performance/browsing_test.rb",
    "test/rails_root/test/test_helper.rb",
    "test/rails_root/test/unit/big_site/site_test.rb",
    "test/rails_root/test/unit/helpers/big_site/sites_helper_test.rb",
    "test/test_helper.rb"
  ]
